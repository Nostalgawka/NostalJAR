...
public class GuiMainMenu extends GuiScreen
{
    ...
    private void addSingleplayerMultiplayerButtons(int par1, int par2, StringTranslate par3StringTranslate) {
        ...
        this.buttonList.add(new GuiButton(2137, this.width / 2 - 100, par2 + par2 * 5.5, "Dolacz na nostalgawke!"));
    }
    ...
    {
        if (par1GuiButton.id == 2137)
        {
            System.out.println("Laczenie z nostalgawka...");
            this.mc.displayGuiScreen(new GuiConnecting(this, this.mc, new ServerData("nostalgawka", "localhost")));
        }
