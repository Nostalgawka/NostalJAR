...
public class NetClientHandler extends NetHandler
{
    ...
    public void handleLogin(Packet1Login par1Packet1Login)
    {
        ...
        try {
            System.out.println("Wysylanie pakietu...");
            this.netManager.addToSendQueue(new Packet250CustomPayload("Jebac|Disa", "Chujnia".getBytes()));
            System.out.println("Wysylano pakiet!");
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
